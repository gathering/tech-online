    ...
    return (
        <div className="frontpage">
            ...
            <div className="frontpage-container">
                ...
                <p>We had to cancel The Gathering, but would otherwise have gathered over 5000 people under the same
                    roof for some digital hilarities. For many of us, The Gathering is an amazing opportunity to learn
                    and experiment.</p>
                <p>To soften the pain, The Gathering:Online is being arranged. But what can Tech-side of The Gathering contribute now that there isn't a large, temporary network to build?</p>
                <p><strong>Enter: Tech:Online.</strong><br/>
                    Tech:Online is a realization that we can still learn and experiment, and even better, we can invite
                    YOU to take part!<br/>Do you have what it takes to set up a LAN? Or do you want to learn as much as you can about
                    operating a professional network? Tech:Online is for you.</p>
                <p>
                    ...
                    will be available throughout the event to help you and guide you.<br/>
